...
import Svg exposing (Attribute, Svg, defs, g, pattern, rect, svg, use)
...
cardSvg attributes card =
    if card.isFacedUp then
        faceUpCardSvg attributes card

    else
        faceDownCardSvg attributes card


faceDownCardSvg : List (Html.Attribute Msg) -> Card -> Svg Msg
faceDownCardSvg attributes _ =
    svg
        ([ class "card"
         , height "3.5in"
        ...
        [ defs [] [ pattern [ id "B2", width "6", height "6", patternUnits "userSpaceOnUse" ] [ Svg.path [ d "M3 0L6 3L3 6L0 3Z", fill "red" ] [] ] ]
        , rect [ width "239", height "335", x "-119.5", y "-167.5", rx "12", ry "12", fill "white", stroke "black" ] []
        , rect [ fill "url(#B2)", width "216", height "312", x "-108", y "-156", rx "12", ry "12" ] []
        ]


faceUpCardSvg : List (Html.Attribute Msg) -> Card -> Svg Msg
faceUpCardSvg attributes card =
    let
        rankSymbol =
